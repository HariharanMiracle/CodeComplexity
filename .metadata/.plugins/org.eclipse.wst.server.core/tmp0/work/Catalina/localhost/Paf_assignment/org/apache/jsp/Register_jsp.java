 ...
 * Generated at: 2019-04-30 22:41:46 UTC
...
public final class Register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<form style = \"text-align: center\" action=\"paf/member/Register\" method=\"POST\" onsubmit=\"return validate()\">\r\n");
      out.write("\t\t\t\t\t<h1>Registration</h1>\r\n");
      out.write("\t\t\t\t\t<label>User Name:</label> <input type=\"text\" name=\"username\" id = \"username\" required/>&nbsp;&nbsp;&nbsp;<span id=\"prusername\" style = \"color:red\"></span><br/>\r\n");
      out.write("\t\t\t\t\t<label>Password:</label> <input type=\"password\" name=\"password\" id = \"pw\" required/><br/>\r\n");
      out.write("\t\t\t\t\t<label>Re-Type Password:</label> <input type=\"password\" name=\"rpassword\" id = \"cpw\" required/>&nbsp;&nbsp;&nbsp;<span id=\"password\" style = \"color:red\"></span><br/>\r\n");
      ...
      out.write("\t\t\t\t\t</select><br/>\r\n");
      out.write("\t\t\t\t\t<label>Address:</label> <input type=\"text\" name=\"address\" id=\"address\" required/>&nbsp;&nbsp;&nbsp;<span id=\"praddress\" style = \"color:red\"></span><br/>\r\n");
      out.write("\t\t\t\t\t<label>Email Address:</label> <input type=\"email\" name=\"mailAddress\" required/><br/>\r\n");
      out.write("\t\t\t\t\t<label>Contact Number:</label> <input type=\"text\" name=\"contactNumber\"  id=\"contactNumber\" required/>&nbsp;&nbsp;&nbsp;<span id=\"prcontactNumber\" style = \"color:red\"></span><br/>\r\n");
      ...
      out.write("\t\t\tvar numeric = /^[0-9]+$/;\r\n");
      out.write("\t\t\tvar alphaNumeric = /^[0-9a-zA-Z]+$/;\r\n");
      out.write("\r\n");
      out.write("\t\t\tif(pw == cpw){\r\n");
      out.write("\t\t\t\tdocument.getElementById(\"password\").innerHTML = \"\";\r\n");
      out.write("\t\t\t\tif(username.match(letters)){\r\n");
      out.write("\t\t\t\t\tdocument.getElementById(\"prusername\").innerHTML = \"\";\r\n");
      out.write("\t\t\t\t\tif(username.length > 3){\r\n");
      out.write("\t\t\t\t\t\tdocument.getElementById(\"prusername\").innerHTML = \"\";\r\n");
      out.write("\t\t\t\t\t\tif(contactNumber.length == 10){\r\n");
      out.write("\t\t\t\t\t\t\tdocument.getElementById(\"prcontactNumber\").innerHTML = \"\";\r\n");
      out.write("\t\t\t\t\t\t\tif(contactNumber.match(numeric)){\r\n");
      out.write("\t\t\t\t\t\t\t\tdocument.getElementById(\"prcontactNumber\").innerHTML = \"\";\r\n");
      out.write("\t\t\t\t\t\t\t\tif(address.match(letters)){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdocument.getElementById(\"praddress\").innerHTML = \"\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn true;\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\telse{\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdocument.getElementById(\"praddress\").innerHTML = \"Address should be an alphabetic value!!!\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\telse{\r\n");
      out.write("\t\t\t\t\t\t\t\tdocument.getElementById(\"prcontactNumber\").innerHTML = \"Contact Number should be a numeric value!!!\";\r\n");
      out.write("\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\telse{\r\n");
      out.write("\t\t\t\t\t\t\tdocument.getElementById(\"prcontactNumber\").innerHTML = \"Contact Number should be 10 digits!!!\";\r\n");
      out.write("\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\telse{\r\n");
      out.write("\t\t\t\t\t\tdocument.getElementById(\"prusername\").innerHTML = \"User Name should be more than 4 letters!!!\";\r\n");
      out.write("\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\telse{\r\n");
      out.write("\t\t\t\t\tdocument.getElementById(\"prusername\").innerHTML = \"User Name should be an alphabetic value!!!\";\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\telse{\r\n");
      out.write("\t\t\t\tdocument.getElementById(\"password\").innerHTML = \"Re-type password again!!!\";\r\n");
      out.write("\t\t\t\treturn false;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\t\r\n");
      out.write("\t</script>\r\n");
