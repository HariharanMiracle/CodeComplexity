...
<!-- Preloader -->
                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="akameNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    <li class="active"><a href = "Homepage.jsp" style = "color: gold">Home page</a></li>
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            <li><a href = "Homepage.jsp" style = "color: gold">Home page</a></li>
	...
	<div style = "text-align: center;">
		<pre style = "color: gold; font-family:sans-serif; font-size: 24px; width: 70%; margin-left: 15%"><b><u>My Profile</u></b></pre>
		<br/>
		<h4 style = "color: gold">User Name: <%=username %></h4>
		<h4 style = "color: gold">User Type: <%=type %></h4>
		<h4 style = "color: gold">Address: <%=address %></h4>
		<h4 style = "color: gold">Mail Id: <%=mailAddress %></h4>
		<h4 style = "color: gold">Contact Number: <%=contactNumber %></h4>
		<br/>
		<pre style = "font-family:sans-serif; font-size: 12px; width: 70%; margin-left: 15%; color: gold">  <a href = "paf/member/updateForm?username=<%=un%>">Edit My Profile</a>          <a href = "paf/member/deactivate?username=<%=un%>">Deactivate my account</a></pre>
	</div>
